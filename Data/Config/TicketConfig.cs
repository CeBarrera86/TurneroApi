...
public class TicketConfig : IEntityTypeConfiguration<Ticket>
{
  public void Configure(EntityTypeBuilder<Ticket> builder)
  {
    ...
    builder.ToTable("tickets", t => t.HasCheckConstraint("ck_tickets_letra", "letra REGEXP '^[A-Z]{1,2}$'"));
    ...
    builder.HasOne(t => t.ClienteNavigation).WithMany(c => c.Tickets).HasForeignKey(t => t.ClienteId).OnDelete(DeleteBehavior.Restrict);
    ...
    builder.HasIndex(e => e.ClienteId).HasDatabaseName("idx_tickets_cliente");
    builder.HasIndex(e => new { e.SectorIdActual, e.EstadoId }).HasDatabaseName("idx_ticket_sector_estado");
    builder.HasIndex(e => e.Fecha).HasDatabaseName("idx_tickets_fecha");
  }
}