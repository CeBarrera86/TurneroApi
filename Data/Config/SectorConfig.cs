...
public class SectorConfig : IEntityTypeConfiguration<Sector>
{
  public void Configure(EntityTypeBuilder<Sector> builder)
  {
    ...
    builder.Property(e => e.Activo).HasColumnType("tinyint(1)").HasColumnName("activo").IsRequired();
    ...
    builder.Property(e => e.PadreId).HasColumnType("int(10) unsigned").HasColumnName("padre_id");
    builder.HasOne(d => d.Padre).WithMany(p => p.InversePadre).HasForeignKey(d => d.PadreId).HasConstraintName("sectores_ibfk_1");
  }
}